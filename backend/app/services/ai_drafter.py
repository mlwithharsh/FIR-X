...
def _fallback_description(data: ReportRequest) -> str:
    ...
    insurance = data.vehicle.insurance_company or "insurance details not yet supplied"
    age_fragment = f", aged about {data.victim.age} years," if data.victim.age is not None else ""
    ...
    return (
        ...
        f"{data.vehicle.registration_number}, stated to be a {data.vehicle.type}, allegedly driven by "
